...
const SliderRoot = ({
  ...
  return (
    <div
      className={cn(className, breakout && 'ml-[calc(50%-50vw)] w-screen px-0')}
    >
      <div className="relative">
        <div
          ...
          className={cn(
            ...
            breakout &&
              'tablet:pl-[max(2.5rem,calc(50vw_-_600px))] tablet:scroll-pl-[max(2.5rem,calc(50vw_-_600px))] scroll-pl-[max(1rem,calc(50vw_-_600px))] pl-[max(1rem,calc(50vw_-_600px))]',
          )}
        >
          {children}
        </div>
